      ...
      return (
        <div className="diff-state diff-state-error" role="alert">
          <p className="annot text-sm text-mark-bright">
            This artifact could not be parsed as a unified diff. The stored patch is shown below.
          </p>
          <pre className="mt-3 max-h-[32rem] overflow-auto border-l border-rule-strong bg-ground-raised p-4 font-mono text-xs leading-relaxed text-ink-secondary">
            {content.diff}
          </pre>
        </div>
      );
